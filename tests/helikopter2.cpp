...
/*     Point ls = { {la[0][0] - midx, la[0][1] - midy} };
    ...
    Point prop2av = prop2a.rotatePointPivot2D(angle * 1.25, { rv[0][0], rv[0][1] }, false);
    Point prop2bv = prop2b.rotatePointPivot2D(angle * 1.25, { rv[0][0], rv[0][1] }, true);

    d[0].position = { prop2av[0][0],prop2av[0][1] };
    d[0].color = sf::Color::Green;
    d[1].position = { prop2bv[0][0],prop2bv[0][1] };
    d[1].color = sf::Color::Green;
